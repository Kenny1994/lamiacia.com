...
<div class="wrapper">
    ...
    <div class="widgets">
        ...
        <div class="oneTwo">
            <div class="widget">
                <div class="title">
                    <img src="<?php echo base_url('assets/admin')?>/images/icons/dark/money.png" class="titleIcon">
                    <h6>Doanh số</h6>
                </div>
        ...
        <div class="oneTwo">
            <div class="widget">
                <div class="title">
                    <img src="<?php echo base_url('assets/admin')?>/images/icons/dark/users.png" class="titleIcon">
                ...
                <tr>
                    ...
                    <td class="textC">
                        <a href="admin/tran/view/21.html" class="lightbox">
                            <img src="<?php echo base_url('assets/admin')?>/images/icons/color/view.png">
                        </a>
